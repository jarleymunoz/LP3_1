  ...
  <div class="index">
    <div class="index input">
      <form method="post">
        ...
        <input type="submit" class="login" name="lnkUsuarios" value="Usuarios">

        <input type="submit" class="login" name="lnkCursos" value="Cursos">

        <input type="submit" class="login" name="lnkMatricula" value="Matricula">
